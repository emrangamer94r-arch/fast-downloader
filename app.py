...
<div class="container">
    ...
    <!-- টেলিগ্রাম মেম্বার বাড়ানোর ব্যানার -->
    <div class="tg-banner">
...
function getDownloadLink() {
    ...
    .then(data => {
        if(data.success) {
            ...
            linksContainer.innerHTML = `<a href="${data.download_url}" class="download-btn" target="_blank" download>⬇️ ক্লিক করে ভিডিও ডাউনলোড করুন</a>`;
        } else {
